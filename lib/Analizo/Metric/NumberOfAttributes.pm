...
Analizo::Metric::NumerOfAttributes - Number of Attributes metric

=head1 DESCRIPTION

The metric calculation is based on the following article and calculates the number 
of attributes of a class.
...
"Calculates the number of attributes of a class. Its minimum value is zero 
and there is no upper limit to its result. A class with many attributes may 
