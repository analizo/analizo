Feature: number of abstract classes
  ...
  Scenario: "Hello, world" project
    ...
    Then analizo must report that the project has total_modules_with_defined_attributes = 1
    Examples:
      | language |
      | cpp      |
      | java     |
  ...
  Scenario: "Animals" project
    ...
    When I run "analizo metrics ."
    Then analizo must report that the project has total_modules_with_defined_attributes = 2
    Examples:
      | language |
      | cpp      |
      | java     |
